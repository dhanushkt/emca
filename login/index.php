...
<![endif]-->
	<script type="text/javascript">
		function showPass() {
			...
			var y = document.getElementById("passtext");
			if (x.type==="password") {
				x.type = "text";
            ...
            <div class="white-box">
				...
				<?php if(isset($smsg)) { ?> <div class="alert alert-success"> <?php echo $smsg; ?> </div><?php }?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input tabindex="2" class="form-control" type="password" name="password" required id="pass" placeholder="Password" >
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                <input onClick="showPass()" name="toggle-password" id="checkbox-signup" type="checkbox">
                                <label id="passtext" for="checkbox-signup"> Show password </label>
                            </div>
