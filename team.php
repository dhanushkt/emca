...
<!--HEADER END-->
    ...
    <!--Banner Inner-->
    <section>
        <div class="lgx-banner lgx-banner-inner" style="background-image:  url(assets/img/bg-2.jpg);">
                        ...
                        <div class="col-xs-12">
                            <div class="lgx-heading-area">
                                <div class="lgx-heading lgx-heading-white">
                                    <h2 class="heading">TEAM SAMCA</h2>
                                </div>
                                <ul class="breadcrumb">
...
<!--
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4 customstyle">
                            <div class="lgx-single-speaker2" > 
                                <figure> 
                                    <a class="profile-img" href="speakers.html"><img src="assets/images/team/praneeth.jpeg" alt="Speaker"/></a>
                                    <figcaption>
                                        ...
                                        <div class="speaker-info">
                                            <h3 class="title"><a href="speaker.html">Praneeth J Shetty</a></h3>
                                            <h4 class="subtitle">President</h4>
...
-->
                    ...
                    <div class="row">
                        <div class="col-xs-12" >
							...
							<div class="lgx-col4 lgx-single-speaker2">
                                <figure>
                                    <a class="profile-img" href="JavaScript:Void(0);"><img src="assets/images/team/govind.png" alt="Speaker"/></a>
                                    <figcaption>
                        ...
                        <div class="col-xs-12"  >
							 ...
							 <div class="lgx-col4 lgx-single-speaker2"       >
                                <figure>
                                    ...
                                    <figcaption>
                                        <div class="social-group">
                                            <a class="sp-tw" href="https://github.com/dhanushkt"><i class="fa fa-github"></i></a>
                                            <a class="sp-fb" href="https://www.facebook.com/dhanushkt"><i class="fa fa-facebook"></i></a>
                                            <a class="sp-insta" href="https://www.instagram.com/im_mr_infinity"><i class="fa fa-instagram"></i></a>
                                            <a class="sp-in" href="https://www.linkedin.com/in/dhanush-k-t-a0ba35168"><i class="fa fa-linkedin"></i></a>
                                        </div>
                                        <div class="speaker-info">
...
<!--                                            <h4 class="subtitle"><b>Development Team</b></h4>-->
                            ...
                            <div class="lgx-col4 lgx-single-speaker2">
                                <figure>
                                    <a class="profile-img" href="JavaScript:Void(0);"><img src="assets/images/team/vignesh.png" alt="Speaker"/></a>
                                    <figcaption>
                                        <div class="social-group">
