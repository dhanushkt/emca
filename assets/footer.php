<footer>
    <div id="lgx-footer" class="lgx-footer"> <!--lgx-footer-white-->
        <div class="lgx-inner-footer" style="background-color: #1b112c;">
            
            <div class="container">
                <div class="lgx-footer-area">
                    <div class="lgx-footer-single">
                        <a class="logo" href="index.php"><img src="assets/img/samca-footer-logo.png" alt="Logo"></a>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
                        ...
                        <a id="myModalLabel2" data-toggle="modal" data-target="#lgx-modal-map" class="map-link" href="#"><i class="fa fa-map-markers" aria-hidden="true"></i> </a>
                    </div>
                    <div class="lgx-footer-single">
                        ...
                        <ul class="list-inline lgx-social-footer">
                            ...
                            <li><a href="login"><i class="fa fa-link" aria-hidden="true"></i></a></li>
